...
class ProductAttributeRelation
{
    ...
    /**
     * @var Product
     * @ORM\ManyToOne(targetEntity="Product",inversedBy="productAttributeRelation",fetch="EXTRA_LAZY")
     ...
     * @ORM\ManyToOne(targetEntity="ProductAttribute",inversedBy="productAttributeRelation",fetch="EXTRA_LAZY")
